...
public class MemoChangeActivity2 extends Activity {
...
//                    productSites.add(productSites1);
                    saveData(productSites1);
                    Toast.makeText(MemoChangeActivity2.this, "메모가 저장되었습니다.", Toast.LENGTH_SHORT).show();
                    finish();
    ...
    public void readData() {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    productSites.add(new ProductSite(jsonObject.getString("siteName"),
