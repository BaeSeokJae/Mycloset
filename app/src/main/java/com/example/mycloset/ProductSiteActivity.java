...
public class ProductSiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl(siteLinks);

        select = findViewById(R.id.select1);
        select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ProductSiteActivity.this, "찜하기 목록에 추가되었습니다.", Toast.LENGTH_SHORT).show();
        ...
        memo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductSiteActivity.this, MemoChangeActivity2.class);
